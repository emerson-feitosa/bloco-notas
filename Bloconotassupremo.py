...
def janela_principal():
    ...
    titulo = ["Robin", "Batman", "Coringa", "Arlequina"]
    janela.title(random.choice(titulo))

    texto = Text(janela, wrap="word", height=40, width=100, font="Arial 14")
    texto.pack()
...
def salvar_arquivo_janela(texto):
    ...
    if i < 1:
        while i < 1:
            salvar_como_arquivo_janela(texto)
            i += 1
